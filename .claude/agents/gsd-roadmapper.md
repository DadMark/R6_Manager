...
Reference full template: `/home/user/R6_Manager/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/R6_Manager/.claude/gsd-core/templates/state.md`.
