...
<reference>
@/home/user/R6_Manager/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/R6_Manager/.claude/gsd-core/references/user-profiling.md` to load:
