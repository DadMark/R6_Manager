...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/R6_Manager/.claude/.gsd-surface.json`
(sibling to `/home/user/R6_Manager/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/R6_Manager/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/R6_Manager/.claude/skills`).
...
`/home/user/R6_Manager/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/R6_Manager/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/R6_Manager/.claude/.gsd-surface.json`
Install profile marker: `/home/user/R6_Manager/.claude/.gsd-profile`
Skill dirs: `/home/user/R6_Manager/.claude/skills/gsd-*/`
Engine module: `/home/user/R6_Manager/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/R6_Manager/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
