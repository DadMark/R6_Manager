...
<!-- For checkpoint task examples and patterns, see @/home/user/R6_Manager/.claude/gsd-core/references/checkpoints.md -->
...
See `/home/user/R6_Manager/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/user/R6_Manager/.claude/gsd-core/templates/user-setup.md` for full schema and examples
