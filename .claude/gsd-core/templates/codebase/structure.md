...
- Usage: Reference from command with `@/home/user/R6_Manager/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/user/R6_Manager/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/user/R6_Manager/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
