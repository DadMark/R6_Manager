...
@/home/user/R6_Manager/.claude/gsd-core/references/agent-contracts.md
@/home/user/R6_Manager/.claude/gsd-core/references/context-budget.md
@/home/user/R6_Manager/.claude/gsd-core/references/gates.md
</required_reading>
...
@/home/user/R6_Manager/.claude/gsd-core/references/execute-phase-response-language.md
...
- Executor agents omit extended deviation rule examples and checkpoint examples from inline prompt — load on-demand via @/home/user/R6_Manager/.claude/gsd-core/references/executor-examples.md
- Planner agents omit extended anti-pattern lists and specificity examples from inline prompt — load on-demand via @/home/user/R6_Manager/.claude/gsd-core/references/planner-antipatterns.md
...
```
Pure doc-only / config-only / test-only tasks return `is_behavior_adding=false` and are exempt. When the gate trips, Read `/home/user/R6_Manager/.claude/gsd-core/references/execute-mvp-tdd.md` for the exact halt report format.
</step>
...
2. For each plan (sequentially, ignoring wave grouping):
   ...
   c. **If "Execute":** Read and follow `/home/user/R6_Manager/.claude/gsd-core/workflows/execute-plan.md` **inline**
...
@/home/user/R6_Manager/.claude/gsd-core/references/execute-phase-wave-guard.md

@/home/user/R6_Manager/.claude/gsd-core/references/execute-phase-context-guard.md
   ...
   Agent(
    ...
    description="Execute plan {plan_number} of phase {phase_number}",
     ...
     prompt="
       ...
       - `/home/user/R6_Manager/.claude/gsd-core/references/checkpoints.md`
       - `/home/user/R6_Manager/.claude/gsd-core/references/tdd.md`
       - `/home/user/R6_Manager/.claude/gsd-core/references/worktree-path-safety.md`
       ${CONTEXT_WINDOW < 200000 ? '' : '- `/home/user/R6_Manager/.claude/gsd-core/references/executor-examples.md`'}
       </execution_context>
...
@/home/user/R6_Manager/.claude/gsd-core/references/execute-phase-quota-recovery.md

@/home/user/R6_Manager/.claude/gsd-core/references/execute-phase-between-wave-reset.md
...
**TDD review escalation (overrides the advisory default for the `tdd.review-checkpoint` gate only).** The tdd `execute:post` gate is declared `blocking: false`, so by the generic contract above it displays its `message`/table and continues. There is ONE documented exception (see `/home/user/R6_Manager/.claude/gsd-core/references/execute-mvp-tdd.md`): when `MVP_MODE=true` AND `TDD_MODE=true` AND `GATE_RESULT.block == true` (one or more TDD plans miss a RED or GREEN gate commit), the end-of-phase TDD review escalates from advisory to **blocking under MVP+TDD** — refuse to mark the phase complete and present:
...
**If gaps_found:**
@/home/user/R6_Manager/.claude/gsd-core/references/execute-phase-requirement-revert.md
```
...
@/home/user/R6_Manager/.claude/gsd-core/workflows/transition.md
</step>
