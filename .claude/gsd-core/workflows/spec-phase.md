...
ones). Reference: @/home/user/R6_Manager/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/user/R6_Manager/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/user/R6_Manager/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/user/R6_Manager/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/user/R6_Manager/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/user/R6_Manager/.claude/gsd-core/templates/spec.md.
