...
```
Agent(
  prompt="Read /home/user/R6_Manager/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/R6_Manager/.claude/gsd-core/templates/VALIDATION.md`
