...
<required_reading>
@/home/user/R6_Manager/.claude/gsd-core/references/ai-frameworks.md
@/home/user/R6_Manager/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/user/R6_Manager/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/user/R6_Manager/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/user/R6_Manager/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/user/R6_Manager/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/user/R6_Manager/.claude/agents/gsd-eval-planner.md for instructions.
