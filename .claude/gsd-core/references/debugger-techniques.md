...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/R6_Manager/.claude
                  → checks /home/user/R6_Manager/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/R6_Manager/.claude/gsd-core
                  → writes to /home/user/R6_Manager/.claude/gsd-core/hooks/
